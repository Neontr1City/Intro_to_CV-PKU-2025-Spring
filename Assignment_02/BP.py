...
if __name__ == "__main__":
    ...
    for i in range(50):
        ...
        d_loss_pred_y = - gt_y / pred_y + (1 - gt_y) / (1 - pred_y)  # (10,1)
        d_loss_output_layer_2 = d_loss_pred_y * pred_y * (1 - pred_y)  # (10,1) derivative of sigmoid
        grad_layer_2 = output_layer_1_act.T.dot(d_loss_output_layer_2)  # (16,1)
        
        d_loss_output_layer_1_act = d_loss_output_layer_2.dot(MLP_layer_2.T) # (10,16)
        d_loss_output_layer_1 = d_loss_output_layer_1_act * output_layer_1_act * (1 - output_layer_1_act) # (10,16) derivative of sigmoid
        grad_layer_1 = input_vector.T.dot(d_loss_output_layer_1) # (784,16)
